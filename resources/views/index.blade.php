  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 hero-content">
        ...
        <p class="mb-4">ResepKu adalah website penyedia menu resep makanan lengkap dan terjamin enak dari chef ternama.</p>
        <a href="{{ route('menu') }}" class="btn btn-warning fw-bold text-white px-4 py-2">Cari Menu</a>
      </div>
      <div class="col-lg-6 text-center">
        <img src="{{ asset('images/nasi-tumpeng.png') }}" alt="Nasi Tumpeng" class="img-fluid rounded shadow">
      </div>
    </div>
  </div>
</section>
...
<section class="py-5 text-center">
  <div class="container">
    ...
    <p class="mb-4 px-md-5 mx-auto" style="max-width: 800px;">Website Resepku memiliki fitur tanya AI. Dengan upload foto atau menuliskan nama resep beserta langkah-langkahnya, fitur menggunakan AI akan segera mencarikan resep dengan cepat dan akurat.</p>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 section-content">
        ...
        <p class="mb-4">Melalui fitur simpan resep, kamu dapat menyimpan resep untuk dibaca di kemudian hari.</p>
        <a href="#" class="btn btn-warning text-white fw-bold px-4 py-2">Coba Sekarang!</a>
      </div>
      <div class="col-lg-6 text-center simpan-resep-img">
        <img src="{{ asset('images/kumpulan-makanan.png') }}" alt="Kumpulan Makanan" class="img-fluid rounded shadow">
      </div>
    </div>
  </div>
</section>
